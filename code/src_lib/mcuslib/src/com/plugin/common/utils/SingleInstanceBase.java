    ...
    public static class SingleInstanceManager {
        ...
        public SingleInstanceBase makeNewInstance(Class classType) {
            ...
            try {
                ...
                if (DEBUG) {
                    Log.d(TAG,
                            "[[makeNewInstance]] Constructor = " + c.toGenericString() + " accessible = "
                                    + c.isAccessible());
                }
                ...
                if (DEBUG) {
                    Log.d(TAG, "[[makeNewInstance]] create obj = " + obj + " SingleInstanceBase is "
                            + (obj instanceof SingleInstanceBase));
                }
